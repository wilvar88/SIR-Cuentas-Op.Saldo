...
window.HOTSPOTS = [
  {
    x: 30.8, y: 44.5, n: 1,
    title: "Operativa de saldo:",
    text: "Formulario para realizar el incremento o decremento del saldo de una cuenta ABT, se deben diligenciar todos los campos obligatorios."
  },
];
